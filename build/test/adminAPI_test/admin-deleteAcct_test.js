...
describe('Admin can delete an account number', function () {
  it('should return a status 200 if the account is successfully deleted', function (done) {
    ...
    _chai["default"].request(_server["default"]).post('/api/v1/auth/signin').send(body).end(function (err, res) {
      ...
      _chai["default"].request(_server["default"])["delete"]("/api/v1/admin/".concat(id, "/account/1004837498")).set('Authorization', token).end(function (er, resp) {
  ...
  it('should return a status 401 if the user is not a staff or admin', function (done) {
    ...
    _chai["default"].request(_server["default"]).post('/api/v1/auth/signin').send(body).end(function (err, res) {
      ...
      _chai["default"].request(_server["default"])["delete"]("/api/v1/admin/".concat(id, "/account/100495432")).set('Authorization', token).end(function (er, resp) {
  ...
  it('should return a status 400 if account does not exit', function (done) {
    ...
    _chai["default"].request(_server["default"]).post('/api/v1/auth/signin').send(body).end(function (err, res) {
      ...
      _chai["default"].request(_server["default"])["delete"]("/api/v1/admin/".concat(id, "/account/107495432")).set('Authorization', token).end(function (er, resp) {
  ...
  it('should return a status 401 is user does not have a valid or expired token', function (done) {
    ...
    _chai["default"].request(_server["default"])["delete"]("/api/v1/admin/".concat(id, "/account/100495432")).set('Authorization', 'ghjklldiOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmaXJzdE5hbWUiOiJtb25kYXkiLCJlbWFpbCI6Im1vbmRheXR1ZXNkYXlAZ21haWwuY29tIiwiaWF0IjoxNTU0OTM3Njc4LCJleHAiOjE1NTQ5NDQ4NzgsImlzcyI6Im1vbmRheS5sdW5kaWkifQ.XBP-AmW9ssM6T3GYeQIY-GUGMu7vjR2bbXey3Hc0dUU').end(function (err, res) {
