...
describe('Admin can view all admin in the database', () => {
      ...
      .end((err, res) => {
        ...
        chai.request(server)
          ...
          .end((er, resp) => {
            ...
            expect(resp.body.data[0].isadmin).to.equals(true);
            done();
          });
      });
  });
  it('should return a status 400 if query parameter \'type\' is not equal admin', (done) => {
    const body = {
      email: 'onumonday@email.com',
      password: 'password',
    };
