...
describe('Admin can change their password', () => {
  it('should return a status 200 if the request is successful', (done) => {
    const body = {
      email: 'peacejoy@email.com',
      password: 'password',
    };
    chai.request(server)
      ...
      .end((err, res) => {
        ...
        chai.request(server)
          .patch(`/api/v1/admin/${id}/changePassword`)
          .send(body2)
  ...
  it('should return a status 401 if the user is not an admin', (done) => {
    const body = {
